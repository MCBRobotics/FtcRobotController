...
public class SimplifiedOdometryRobot {
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("left_front_drive", DcMotor.Direction.REVERSE);
        rightFrontDrive = setupDriveMotor("right_front_drive", DcMotor.Direction.REVERSE);
        leftBackDrive  = setupDriveMotor( "left_back_drive", DcMotor.Direction.FORWARD);
        rightBackDrive = setupDriveMotor( "right_back_drive",DcMotor.Direction.FORWARD);
